        ...
        <>
            <div className='w-[90%] mx-auto'>
                <div className='mt-8'>
                    <div>
                        <div>
                            <h3 className='font-semibold text-3xl text-[#0C0C0C]'>Sustainably Sourced Materials</h3>
                        </div>
                        <div className='capitalize text-xl/8 font-normal text-[#0C0C0C] mt-8'>
                            <p>
                    ...
                    <div className='flex mt-10 gap-10'>
                        <div className="left w-[30%]">
                            <img src={IMAGES.susmaterialOne} alt="" />
                        </div>
                        <div className="right w-[70%] mt-[40px]">
                            <div>
                                <h4 className='font-bold text-xl text-[#0C0C0C]'>Cotton</h4>
                            </div>
                            <div className='capitalize font-normal text-lg/8 text-[#0C0C0C] mt-3'>
                                <p>
                    ...
                    <div className='flex mt-10 gap-10'>
                        <div className="left w-[60%] mt-[25px]">
                            <div>
                                <h4 className='font-bold text-xl text-[#0C0C0C]'>Wool</h4>
                            </div>
                            <div className='capitalize font-normal text-lg/7 text-[#0C0C0C] mt-3'>
                                <p>
                        ...
                        <div className="right w-[40%] h-[330px]">
                            <img src={IMAGES.susmaterialTwo} alt="" />
                        </div>
                    </div>
                    <div className='flex mt-10 gap-10'>
                        <div className="left w-[40%] h-[408px]">
                            <img src={IMAGES.susmaterialThree} alt="" />
                        </div>
                        <div className="right w-[60%] mt-[80px]">
                            <div>
                                <h4 className='font-bold text-xl text-[#0C0C0C]'>Linen</h4>
                            </div>
                            <div className='capitalize font-normal text-lg/8 text-[#0C0C0C] mt-3'>
                                <p>
                    ...
                    <div className='flex mt-10 gap-10'>
                        <div className="left w-[60%] mt-[70px]">
                            <div>
                                <h4 className='font-bold text-xl text-[#0C0C0C]'>Silk</h4>
                            </div>
                            <div className='capitalize font-normal text-lg/7 text-[#0C0C0C] mt-3'>
                                <p>
                        ...
                        <div className="right w-[40%] h-[408px]">
                            <img src={IMAGES.susmaterialFour} alt="" />
                        </div>
                    </div>
                    <div className='flex mt-10 gap-10'>
                        <div className="left w-[30%] h-[434px]">
                            <img src={IMAGES.susmaterialFive} alt="" />
                        </div>
                        <div className="right w-[70%] mt-[80px]">
                            <div>
                                <h4 className='font-bold text-xl text-[#0C0C0C]'>Cashmere</h4>
                            </div>
                            <div className=' capitalize font-normal text-lg/8 text-[#0C0C0C] mt-3'>
                                <p>
                ...
                <div className='font-normal text-xl/8 text-[#0C0C0C] mt-[20px]'>
                    <p>
                ...
                <div className='font-normal text-xl/8 text-[#0C0C0C] mt-[40px] mb-[40px]'>
                    <p>
