            ...
            <div className="images mt-5 ">
                <div className="container lg:mx-auto flex items-center justify-center flex-wrap gap-[3rem] md:mx-auto sm:mx-auto px-3">
                    <div className="img1 relative ">
                        <img src={product4} alt="" className=' sm:w-[600px] h-[518px] cursor-pointer' />
                        <button className='btn bg-white md: absolute right-3 top-110 font-normal py-2 px-10 cursor-pointer'>{button}Boluses</button>
                        <img src={product6} alt="" className='w-[600px] h-[900px] mt-8 cursor-pointer ' />
                    ...
                    <div className="img2 relative">
                        ...
                        <button className='btn bg-white absolute right-3 top-180 px-10 py-3 cursor-pointer'>{button}Pants</button>
                        <img src={product7} alt="" className='w-[600px] h-[518px] mt-[8.4rem] cursor-pointer' />
                        <button className='btn bg-white absolute right-3 bottom-10 px-10 py-3 cursor-pointer'>{button}Outwear</button>
                    </div>
