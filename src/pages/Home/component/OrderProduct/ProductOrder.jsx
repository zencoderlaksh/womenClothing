...
const ProductOrder = () => {
    ...
    const productorderData = [
        ...
        {
            id: 2,
            img: IMAGES.ProductOrderImgThre,
        ...
        {
            id: 3,
            img: IMAGES.ProductOrderImgFour,
            title: 'New Age Linen',
            ...
            <div className="container mx-auto flex flex-col w-full gap-6 sm:flex-row sm:gap-8 md:gap-12 md:max-w-[1200px] p-4">
                ...
                <div className="right">
                    <div className='bg-[#F0F2EF] p-[16px]'>
                        ...
                        <div>
                            <p>This material is our signature high-stretch fabric that drapes like silk and is soft to the touch. Silk is OEKO-TEX® certified and made in Italy in a mill 100% powered by renewable energy (solar and biomass)</p>
                        </div>
                        ...
                        <div className='mt-[40px] '>
                            <div className='flex flex-wrap items-center gap-4 sm:justify-center' >
                                ...
                                <button className='bg-white px-3 py-2'>Chemical Free</button>
